...
from apps.academics.models import Grade, Transcript
...
def honor_roll(*, term_id: int, settings=None) -> QuerySet[Grade]:
...
def academic_warnings(*, term_id: int, settings=None) -> QuerySet[Grade]:
